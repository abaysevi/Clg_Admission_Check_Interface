...
if(!empty($_POST["submit_email"])) {
	...
	if($count>0) {
		$error_message = "Email Already Used College will contact You";
		...
		if($mail_status == 1) {
			// $asid=rand(0,100);
			$result = mysqli_query($conn,"INSERT INTO otp_expiry(id,otp,is_expired,create_at) VALUES (1,'" . $otp . "', 0, '" . date("Y-m-d H:i:s"). "')");
